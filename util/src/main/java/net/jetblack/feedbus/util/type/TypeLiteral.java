package net.jetblack.feedbus.util.type;
...
public abstract class TypeLiteral<T> {
	...
	/**
	 * A copy constructor.
	 * @param typeLiteral The value to copy.
	 */
	...
	public static <S> TypeLiteral<?> create(Class<S> clazz) {
		...
		return new TypeLiteral<S>(clazz.getGenericSuperclass()) {
			/* magic */};
	}

	/**
	 * Creates a type literal from an object.
	 * @param object The object to examine.
	 * @return The type literal for the value.
	 */
	...
	/**
	 * Creates a type literal from a type.
	...
	/**
	 * Creates a class froma type literal.
	 * @return The class for the type literal.
	 */
	...
	/**
	 * Create a known generic type from an wildcard generic type.
	 * @param clazz The class to convert.
	 * @return A known generic class.
	 */
	...
	/**
	 * Converts a type literal to a new type.
	 * @param typeLiteral The source type literal.
	 * @return A type literal of the new type.
	 */
	...
	/**
	 * Gets the component type from a given type.
	...
	/**
	 * Gets the raw type from a given type.
	 * @param type The type.
	 * @return The raw type.
	 */
